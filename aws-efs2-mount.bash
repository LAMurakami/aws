...
# This program mounts the second EFS for a region

# The second EFS for a region has three storage classes
# and uses Lifecycle management to automatically transition
# files between the classes

case ${REGION} in

  af-south-1)
    EFS=fs-0febee1c1999ee5df.efs.af-south-1.amazonaws.com
    ;;

  ap-east-1)
    EFS=fs-0135807df97f2cf6e.efs.ap-east-1.amazonaws.com
    ;;
...
#    ;;
  ...
  us-west-2)
    EFS=fs-0bf0b691780876b53.efs.us-west-2.amazonaws.com
    ;;
...
mkdir /mnt/efs2
echo "${EFS}:/ /mnt/efs2 nfs4 ${nfsOpt}" >> /etc/fstab
